...
export const dropdownStyles = {
  ...
  list: 'max-h-[300px] overflow-y-auto py-2',

  item: {
    base: 'flex items-center gap-2 py-2 cursor-pointer transition-all text-sm text-gray-900',
  ...
  trigger: {
    base: 'inline-flex items-center justify-between gap-2 font-medium rounded-md transition-colors focus:outline-none border bg-white disabled:opacity-50 disabled:cursor-not-allowed',
    sizes: {
      sm: 'h-8 px-3 text-sm',
